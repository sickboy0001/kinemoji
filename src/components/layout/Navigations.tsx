          ...
          <div className="flex gap-4 items-center">
            {session?.user ? (
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 bg-black text-white text-[12px] font-medium rounded-md hover:bg-slate-800 transition-colors scale-90 origin-right"
              >
                <svg
                  className="w-4 h-4"
                  viewBox="0 0 24 24"
